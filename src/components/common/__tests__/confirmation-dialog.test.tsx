...
describe('ConfirmationDialog', () => {
  ...
  it('handles confirmation errors gracefully', async () => {
    const user = userEvent.setup()
    const errorConfirm = jest.fn().mockRejectedValue(new Error('Confirmation failed'))
...
describe('DeleteConfirmationDialog', () => {
  ...
  it('renders delete-specific content', () => {
    ...
    expect(screen.getByText('「テストアイテム」を削除してもよろしいですか？この操作は取り消せません。')).toBeInTheDocument()
...
describe('ResetConfirmationDialog', () => {
  ...
  it('renders reset-specific content', () => {
    ...
    expect(screen.getByText('すべてのデータがリセットされます。')).toBeInTheDocument()
